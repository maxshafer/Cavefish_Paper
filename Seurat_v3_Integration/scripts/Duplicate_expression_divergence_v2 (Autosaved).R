...
plot.zeb <- ggplot(dTzeb, aes(x = dT, color = branch)) + stat_ecdf(size = 1) + ylab("% of paralog pairs") + theme(axis.text = element_text(size = 8), axis.title = element_text(size = 10), legend.text = element_text(size =8), legend.title = element_text(size = 10)) + scale_color_brewer(type = "seq", palette = "YlOrRd", direction = 1, aesthetics = "colour")
plot.ast <- ggplot(dTast, aes(x = dT, color = branch)) + stat_ecdf(size = 1) + ylab("% of paralog pairs") + theme(axis.text = element_text(size = 8), axis.title = element_text(size = 10), legend.text = element_text(size =8), legend.title = element_text(size = 10)) + scale_color_brewer(type = "seq", palette = "YlOrRd", direction = 1, aesthetics = "colour")
plot.id <- ggplot(dTid, aes(x = dT, color = identity)) + stat_ecdf(size = 1) + ylab("% of paralog pairs") + theme(axis.text = element_text(size = 8), axis.title = element_text(size = 10), legend.text = element_text(size =8), legend.title = element_text(size = 10)) + scale_color_brewer(type = "seq", palette = "YlOrRd", direction = 1, aesthetics = "colour")

plot.zeb + plot.ast + plot_annotation(title = "Duplicate Divergence by gene age or % identity")

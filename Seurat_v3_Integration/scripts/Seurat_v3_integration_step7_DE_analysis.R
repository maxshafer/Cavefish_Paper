...
DotPlot(hypo.integrated, features = row.names(markers.Subtypes.filtered[[1]])[1:100], group.by = "integrated_Subtype", split.by = "species.2", cols = c("blue", "red")) + RotatedAxis()

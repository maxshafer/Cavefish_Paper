...
hypo.integrated.2 <- RunPCA(object = hypo.integrated.2, assay = "RNA", npcs = 100, verbose = FALSE)
hypo.integrated.2 <- RunTSNE(object = hypo.integrated.2, reduction = "pca", dims = 1:100, check_duplicates = F)

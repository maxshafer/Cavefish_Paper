...
DotPlot(object = hypo, features = rev(c("gng3", "slc17a6a", "gad1b", "her15.1", "prdx1", "otpb", "pfn1", "mpz", "mrc1a", "epd", "hopx", "hbaa2")), group.by = "Subtype") + theme(legend.position = "right") + RotatedAxis() + scale_color_viridis()
dev.off()
